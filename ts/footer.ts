...
var footer:HTMLElement=document.createElement('footer');
 ...
 var textCenter:HTMLDivElement=document.createElement('div');
 ...
 var footerItem1:HTMLAnchorElement=document.createElement('a');
 footerItem1.className+='text';
 footerItem1.style.marginLeft='50px';
 footerItem1.href=(! window.location.href.includes('/pages/'))?'./pages/privacy_policy.html':'./privacy_policy.html';
 footerItem1.innerHTML='Privacy policy';
 textCenter.appendChild(footerItem1);
 //footer item 2 - Termini d'utilizzo
 var footerItem2:HTMLAnchorElement=document.createElement('a');
 ...
 var footerItem3:HTMLAnchorElement=document.createElement('a');
 ...
 var footerItem4:HTMLAnchorElement=document.createElement('a');
