...
createFlipCard("flip-card-container","Autoconfigurante","Self-configuring",imgUrl1, loremIpsumText,descriptionEN);
createFlipCard("flip-card-container","Smart","Smart",imgUrl2, loremIpsumText,descriptionEN);
createFlipCard("flip-card-container","Veloce","Fast",imgUrl3, loremIpsumText,descriptionEN);
createFlipCard("flip-card-container","Sicuro","Secure",imgUrl4, loremIpsumText,descriptionEN);
createFlipCard("flip-card-container-2","Componenti scalabili","Scalable Components",imgUrl5, loremIpsumText,descriptionEN);
createFlipCard("flip-card-container-2","Senori per consultare dati in uscita","Sensor to check output data",imgUrl6, loremIpsumText,descriptionEN);




function createFlipCard(parentEl,titleIT,titleEN,imgLink,backFaceParagraphIT,backFaceParagraphEN){
